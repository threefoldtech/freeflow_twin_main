                ...
                <div class="overflow-hidden sm:rounded-lg">
                    <FileDropArea class="h-full" @click.stop @send-file="uploadFiles">
                        ...
                        <ul
                            ...
                            class="grid grid-cols-2 gap-x-2 gap-y-4 sm:gap-x-4 lg:grid-cols-4 xl:grid-cols-6 2xl:grid-cols-8 xl:gap-x-6"
                            role="list"
                        >
                            <p
                            ...
                            <li v-if="currentDirectory === '/' && route.name === 'quantum'" title="Shared folder">
                                <div
                                    class="group w-full aspect-w-12 aspect-h-4 border border-gray-300 bg-white rounded-md hover:bg-gray-200 transition duration:200 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-100 focus-within:ring-indigo-500 overflow-hidden flex justify-start items-center"
                                    @click="goToShared()"
                                >
                            ...
                            >
                                <div
                                    ...
                                    class="group w-full aspect-w-12 aspect-h-4 rounded-lg border border-gray-300 hover:bg-gray-200 transition duration:200 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-100 focus-within:ring-indigo-500 overflow-hidden flex justify-center items-center"
                                >
