<template>
  <div x-cloak x-show.transition.origin.bottom="open2" x-on:mouseover="open2 = true" x-on:mouseleave="open2 = false"
       class="absolute -top-40 -left-10 bg-white px-4 py-4 w-72 shadow rounded cursor-default z-10">
      ...
      <div class="flex flex-col space-y-2">
        ...
        <div class="flex justify-start items-center space-x-2">
          ...
          <div class="w-auto text-sm leading-none">
            <small>
              347 mutual friends including: <a href="#" class="font-semibold hover:underline">Ujang</a> and <a href="#"
                                                                                                               class="font-semibold hover:underline">Maman</a>
            </small>
          </div>
        </div>
        <div class="flex justify-start items-center space-x-2">
