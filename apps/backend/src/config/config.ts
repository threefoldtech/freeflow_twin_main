export default () => ({
    ...
    appBackend: process.env.NODE_ENV === 'production' ? 'https://login.threefold.me' : 'https://login.staging.jimber.io/',
    ...
    appId: `${process.env.DIGITALTWIN_APPID}` || 'patatje3.digitaltwin.jimbertesting.be',
    seedPhrase:
